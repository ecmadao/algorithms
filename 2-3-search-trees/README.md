...
- [2-3 二叉搜索树](#2-3-%E4%BA%8C%E5%8F%89%E6%90%9C%E7%B4%A2%E6%A0%91)
  ...
  - [节点删除](#%E8%8A%82%E7%82%B9%E5%88%A0%E9%99%A4)
    - [删除非叶子节点](#%E5%88%A0%E9%99%A4%E9%9D%9E%E5%8F%B6%E5%AD%90%E8%8A%82%E7%82%B9)
    - [删除叶子节点](#%E5%88%A0%E9%99%A4%E5%8F%B6%E5%AD%90%E8%8A%82%E7%82%B9)

<!-- END doctoc generated TOC please keep comment here to allow auto update -->

## 2-3 二叉搜索树

2-3 二叉搜索树的每个节点要么有 2 个子节点和 1 个数据元素，要么有 3 个子节点和 2 个数据元素。
...
节点搜索和普通的二叉搜索树没有什么差别，通过和节点上的多个值比较，确定继续搜索它的左节点、中节点还是右节点。
...
直接用**中序遍历下的直接后继节点**替换当前被删除的节点

![](./img/2-3-bst-delete1.png)

#### 删除叶子节点

- 删除的节点内有两个值（即 3 节点），则直接删除

![](./img/2-3-bst-delete2.png)

- 删除的节点内仅一个值（即 2 节点）

1. 被删除节点的父节点是 2 节点，兄弟节点是 3 节点，则删除子节点后，类似左旋的替换

![](./img/2-3-bst-delete3.png)

2. 被删除节点的父节点和兄弟节点都是 2 节点，则：

2.1. 移动兄弟节点中序遍历的直接后继节点 a 到兄弟节点
2.2. 则可利用步骤 1 的方式处理
2.3. 但此时相当于删除了 a 节点，则递归处理

![](./img/2-3-bst-delete4.png)

3. 被删除节点的父节点是 3 节点，则拆分父节点成为 2 节点，再将拆分得到的某值和剩下的某个子节点合并

![](./img/2-3-bst-delete5.png)

4. 2-3 树是满二叉树，则将树从层级减少，并将剩下的兄弟节点合并到父节点；同时将父节点的所有兄弟节点合并到父节点的父节点中

![](./img/2-3-bst-delete6.png)
